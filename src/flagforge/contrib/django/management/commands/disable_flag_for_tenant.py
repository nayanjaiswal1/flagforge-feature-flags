"""Management command to disable a feature flag for a tenant."""
...
class Command(BaseCommand):
    ...
    help = "Disable a feature flag for a tenant"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"Disabled '{flag_key}' for tenant '{tenant_id}'")
